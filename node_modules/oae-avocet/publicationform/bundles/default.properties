...
DOWNLOAD_THE_CAMBRIDGE_ADDENDUM = Download the Cambridge Addendum
...
EG_LEVERHULME_TRUST_UNILEVER = e.g. Leverhulme Trust, Unilever
EG_NEW_YORK_UNIVERSITY = e.g. New York University
EG_ROGERS_IVAN_OR = e.g. &quot;Rogers, Ivan&quot; or &quot;Ivan Rogers&quot;
ENGINEERING_AND_PHYSICAL_SCIENCES_RESEARCH_COUNCIL = Engineering and Physical Sciences Research Council
ENTER_THE_TITLE_OF_YOUR_MANUSCRIPT = Enter the title of your manuscript
EPSRC = EPSRC
ERC = ERC
ESRC = ESRC
...
IF_YOUR_FUNDER_ISNT_LISTED_ENTER_BELOW = If your funder isn't listed, enter below
...
INSTITUTION_OF_THE_CORRESPONDING_AUTHOR = Institution of the corresponding author
...
I_DONT_KNOW_THE_ACCEPTANCE_DATE = I don't know the acceptance date
JOURNAL_OR_CONFERENCE_TITLE = Journal or conference title
...
NIHR = NIHR
NSF = NSF
PLEASE_ENTER_A_CORRECT_DATE = Please enter a correct date
PLEASE_ENTER_A_DATE_WHICH_ISNT_IN_THE_FUTURE = Please enter a date which isn't in the future
...
START_TYPING_FOR_DEPARTMENT_SUGGESTIONS = Start typing for department suggestions
START_TYPING_FOR_JOURNAL_SUGGESTIONS = Start typing for journal suggestions
STFC = STFC
...
USE_THE_CAMBRIDGE_ADDENDUM_TO = Use the Cambridge Addendum to retain some rights to your work.
...
WHICH_FUNDERS_ARE_ACKNOWLEDGED = Which funders are acknowledged?
