...
<div id="oa-publicationform-form-template"><!--
    {macro requiredInputField(label, name, placeholder, className, helpModal, id, helpModalButtonText)}
        <div class="form-group{if className} ${className}{/if}" {if id}id="${id}"{/if}>
            ...
            {if helpModal}<button data-toggle="modal" data-target="${helpModal}" type="button" class="oa-inline-btn-link btn oa-link oa-btn-link oa-inline-btn-link oa-btn-form-help">${ helpModalButtonText || '__MSG__FIND_OUT_MORE__'}</button>{/if}
    ...
    <form id="oa-publicationform" class="oa-form" role="form" data-ga-label="Publication Form">
        <div class="oa-section oa-form-section">
            <div class="container">
                ${requiredInputField('__MSG__TITLE__', 'title', '__MSG__ENTER_THE_TITLE_OF_YOUR_MANUSCRIPT__')}
                ${requiredInputField('__MSG__WHAT_DEPARTMENT_ARE_YOU_UPLOADING_FOR__', 'department', '__MSG__START_TYPING_FOR_DEPARTMENT_SUGGESTIONS__')}
                ${requiredInputField('__MSG__CORRESPONDING_AUTHOR__', 'authors', '__MSG__EG_ROGERS_IVAN_OR__', null, '#oa-submitpublication-author-modal', 'form-group-correspondingauthor')}
                ...
                ${requiredInputField('__MSG__INSTITUTION_OF_THE_CORRESPONDING_AUTHOR__', 'institution', '__MSG__EG_NEW_YORK_UNIVERSITY__', prefill.ucamAuthor === 'no' ? null : 'hide')}
            </div>
        </div>

        <div class="oa-section oa-form-section">
            <div class="container">
                ${requiredInputField('__MSG__JOURNAL_OR_CONFERENCE_TITLE__', 'journal', '__MSG__START_TYPING_FOR_JOURNAL_SUGGESTIONS__', null, '#oa-submitpublication-apc-modal', null, '__MSG__A_NOTE_ON_OPEN_ACCESS_CHARGES__')}

                <div id="form-group-acceptancedate" class="form-group">
                    <label class="control-label oa-publicationform-required" for="oa-publicationform-input-acceptancedate">__MSG__ACCEPTANCE_DATE__</label>
                    <button data-toggle="modal" data-target="#oa-submitpublication-acceptance-modal" type="button" class="oa-inline-btn-link btn oa-link oa-btn-link oa-inline-btn-link oa-btn-form-help">__MSG__FIND_OUT_MORE__</button>
        ...
        <div class="oa-section oa-form-section">
            ...
            <div id="oa-publicationform-funders-container" class="container form-group{if prefill.hasExternalFunders === 'no'} hide{/if}">
                <label class="control-label oa-publicationform-required">__MSG__WHICH_FUNDERS_ARE_ACKNOWLEDGED__</label>
                <div class="row">
                    <div class="col-xs-4">
